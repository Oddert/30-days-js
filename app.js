...
let projects = [
  ...
  , { title: '10. Shift to Check Inputs', workToDo: true, thumbnail: '10. Shift Multple Checkboxes.PNG' }
  ...
  , { title: '16. CSS Mouse Move', workToDo: false, thumbnail: null }
  ...
  , { title: '20. Native Speech Recognition', workToDo: true, thumbnail: null }
  , { title: '21. Geolocation', workToDo: false, thumbnail: null }
  , { title: '22. Link Transition Effect', workToDo: false, thumbnail: null }
  , { title: '23. Speech Synthesis', workToDo: true, thumbnail: null }
  , { title: '24. Sticky Nav Bar', workToDo: false, thumbnail: null }
  , { title: '25. Event Contexts', workToDo: true, thumbnail: null }
  , { title: '26. Stripe Dropdown Example', workToDo: true, thumbnail: null }
